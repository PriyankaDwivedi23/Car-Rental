...
<form name="myForm"  method="post" action="index.php?page=submit" >
  ...
  <tr>
	...
	<td width="65%" scope="col" id="displaydiv">
	
	<img src="images/steps.PNG" width="346" height="453" />
		</td>
  ...
  <tr>
	...
	<div class="services">
       ...
       <h2>Wheels on Hire Blog </h2>
            <p align="justify">Find out Reviews about various locations, features traven destinations, latest packages<span class="readmore"><a href="#">Comming Soon </a></span>        </p>
            </div>	</th>
    <th scope="col">
	<div class="services"><img src="images/trip.png" alt="img" />
	  <h2>Make Your Own Trip </h2>
            <p align="justify">Make a tailor made special package as per your needs ..<br />
            <span class="readmore"><a href="#">Comming Soon </a></span>    </p>
          <th scope="col"><div class="services">
         <img src="images/donate.png" alt="img" />
       <h2>Track Your Booking</h2>
            <p align="justify">We are presently updating our Server. This module will work very Soon.<br /> 
            <span class="readmore"><a href="#">TRACK</a></span>  </p>
          </tr>
  <tr>
