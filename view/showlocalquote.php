...
<body  background="images/bg1.PNG"  leftmargin="0" rightmargin="0">
  ...
  <table width="100%" height="70" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <th height="33" background="images/itenary_bg.PNG" scope="col" class="style1">Select New Location: <?php
	  $city = $this->local->city;
	$duration = $this->local->duration;
	  ?>
	  <select "style=width:160px" name="newlocation" onchange="getLocation('view/newlocation.php?city=<?php echo $this->local->city ?>&duration=<?php echo $this->local->duration ?>&location='+this.value)" >
