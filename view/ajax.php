...
?>
  <table width="100%" height="70" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <th height="33" background="images/itenary_bg.PNG" scope="col"><?php echo $msg;?></th>
      <th height="33" background="images/itenary_bg.PNG" scope="col">&nbsp;</th>
    </tr>
  </table>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" >
  ...
  <?php
	  $result = mysql_query("SELECT vendor.id,carname, description, seating, rateperkm, vendorname, actualquantity, rating, image, companyname
...
WHERE vendor.id = vendor_has_car.vendor_id AND vendor_has_car.car_id = car.id AND vendor.sourcecity = '$source' AND vendor_has_car.actualquantity >0 ") or die(mysql_error());  
    ...
    <th width="13%" height="29" scope="col"><div align="center"><span class="style4"><?php echo $row['companyname']     ?><br />
     <img align="middle" src="<?php echo $row['rating']  ;   ?>"</img><br>
	  </div></span><br /></th>
    ...
    <th width="14%"  scope="col"><div align="center"><span class="style4">&nbsp;&nbsp;&nbsp;Total KM:</span> <span class="style6">&nbsp;<?php echo $km;     ?> &nbsp;&nbsp; <br />
        ...
        </span><br /><?php $amount = $amount + $driver_charge; ?>
		<a href="#" title="ajax:view/external.php?rate=<?php echo $row['rateperkm'] ?>&amount=<?php echo $amount ?>&driver=<?php echo $driver_charge ?>&km=<?php echo $km ?>  ">Fare Summary</a>
      </div></th>
    <th width="18%"scope="col"><span class="style6"><?php  echo "INR " .$amount ?>/-</span></th>
